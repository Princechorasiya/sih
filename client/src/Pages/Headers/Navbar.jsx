      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            {navItems.map((item) => (
              <motion.div key={item.name} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link
                  to={item.path}
                  className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-grey-600 hover:bg-indigo-50 transition duration-150 ease-in-out"
                >
                  {item.name}
                </Link>
              </motion.div>
            ...
            {token && (
              <div className="relative" ref={dropdownRef}>
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                  className="ml-4 px-4 py-2 rounded-md text-sm font-medium bg-indigo-100 text-grey-800 hover:bg-indigo-200 transition duration-150 ease-in-out"
                >
                  {role}
                </motion.button>
                <AnimatePresence>
            ...
            {!token ? (
              <>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Link
                    to="/login"
                    className="px-4 py-2 rounded-md text-sm font-medium text-gray-600 hover:text-gray-700 hover:bg-indigo-50 transition duration-150 ease-in-out"
                  >
                    Login
                  </Link>
                </motion.div>
          ...
          <div className="-mr-2 flex items-center sm:hidden">
            <button
              onClick={() => setIsOpen(!isOpen)}
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-indigo-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-black-500"
            >
              <span className="sr-only">Open main menu</span>
              {isOpen ? (
        ...
        <div className="px-2 pt-2 pb-3 space-y-1 bg-white">
          ...
          {!token ? (
            <>
              <Link
                to="/login"
                className="block px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:text-gray-700 hover:bg-indigo-50 transition duration-150 ease-in-out"
              >
                Login
              </Link>
              <Link
                to="/signup"
                className="block px-3 py-2 rounded-md text-base font-medium bg-gray-600 text-white hover:bg-grey-700 transition duration-150 ease-in-out"
              >
                Signup
              </Link>
            </>
